...
public class Main {
    ...
    private static void allFlightList() {
        ...
        System.out.println("изначальный список перелетов, сгенерированный фабрикой FlightBuilder");
    ...
    private static void removeFlightUpToTheCurrentPointInTime() {
        ...
        separator();
        System.out.println("вывод перелетов с актуальными датами вылетов");
    ...
    private static void removeSegmentsWithAnArrivalDateEarlierThanTheDepartureDate() {
        ...
        separator();
        System.out.println("Исключение перелетов, где сегменты с датой прилёта раньше даты вылета из общего списка");
